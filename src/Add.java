...
public final class Add extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        newf.origin = (String) origin.getSelectedItem();
        newf.destination = (String) destination.getSelectedItem();
        newf.flight_no = Integer.parseInt((String)flight_no.getSelectedItem()) ;
        newf.departure_date = dep_date.getText();
        newf.departure_time = dep_time.getText();
        newf.arrival_time = arr_time.getText();
        newf.plane_id = 0;
        if(FlightsController.addFlight(newf)){
